    ...
    contentSection.innerHTML = `
        ...
        <form id="new-bet-form" class="bet-form" ${betToEdit ? `data-edit-id="${betToEdit.id}"` : ''}>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" required placeholder="Describe your bet">${betToEdit ? betToEdit.description : ''}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="note" name="note" placeholder="Add any additional notes about this bet">${betToEdit && betToEdit.note ? betToEdit.note : ''}</textarea>
